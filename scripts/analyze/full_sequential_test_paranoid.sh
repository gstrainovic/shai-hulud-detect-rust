#!/bin/bash
# Sequential (non-parallel) full test PARANOID MODE - baseline for comparison
...
echo "━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━"
echo "🐢 SEQUENTIAL FULL TEST - PARANOID MODE (Baseline for Comparison)"
echo "━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━"
...
# Phase 1: Bash sequential (PARANOID)
echo "🔵 Phase 1: Running Bash scanners sequentially (PARANOID)..."
bash_count=0
for testdir in "${TESTCASES[@]}"; do
    testname=$(basename "$testdir")
    bash_count=$((bash_count + 1))
    
    echo "  [$bash_count/$TOTAL_TESTS] Testing: $testname (Bash PARANOID)"
    
    cd shai-hulud-detect
    abs_testdir=$(realpath "../$testdir")
    timeout 300 ./shai-hulud-detector.sh --paranoid "$abs_testdir" > "../$LOG_DIR/bash_${testname}.log" 2>&1
    cd ..
...
echo ""
echo "🟢 Phase 2: Running Rust scanners sequentially (PARANOID)..."
rust_count=0
for testdir in "${TESTCASES[@]}"; do
    testname=$(basename "$testdir")
    rust_count=$((rust_count + 1))
    
    echo "  [$rust_count/$TOTAL_TESTS] Testing: $testname (Rust PARANOID)"
    
    cd dev-rust-scanner-1
    abs_testdir=$(realpath "../$testdir")
    cargo run --quiet --release -- --paranoid "$abs_testdir" > "../$LOG_DIR/rust_${testname}.log" 2>&1
    cd ..
...
echo ""
echo "━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━"
echo "📊 SEQUENTIAL TEST RESULTS (PARANOID MODE)"
echo "━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━"
