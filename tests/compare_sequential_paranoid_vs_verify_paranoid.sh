#!/bin/bash
# Compare logs from sequential paranoid mode vs verify paranoid mode
# Usage: ./compare_sequential_paranoid_vs_verify_paranoid.sh

set -euo pipefail

echo "━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━"
echo "🔍 COMPARING SEQUENTIAL PARANOID vs VERIFY PARANOID"
echo "━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━"
echo ""
...
if [ -z "$NORMAL_DIR" ] || [ -z "$VERIFY_DIR" ]; then
    ...
    echo ""
    echo "Please run:"
    echo "  1. bash scripts/analyze/full_sequential_test_paranoid.sh"
    echo "  2. bash scripts/analyze/full_sequential_test_verify_paranoid.sh"
    echo ""
    exit 1
fi

echo "📁 Paranoid logs: $NORMAL_DIR"
echo "📁 Verify Paranoid logs: $VERIFY_DIR"
echo ""
...
if [ $MATCH_COUNT -eq 1 ] && [ $CONTENT_MATCH -eq 1 ]; then
    echo "🎉 SUCCESS! --verify does NOT change results in sequential paranoid mode!"
    exit 0
else
